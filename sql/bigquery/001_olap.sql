...
CREATE TABLE IF NOT EXISTS `nlp.olap.fact_ocr_translation` (fact_key INT64, date_key INT64, calendar_date DATE, script_key INT64, model_key INT64, source_language_key INT64, target_language_key INT64, glyph_count INT64, token_count INT64, confidence NUMERIC, latency_ms NUMERIC, translation_count INT64, human_verified_count INT64)
