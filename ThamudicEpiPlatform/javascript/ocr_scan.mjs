...
if(!image){console.error('usage: node ocr_scan.mjs image [engine]');process.exit(2)}
const form=new FormData();form.append('file',new Blob([await fs.readFile(image)]),'image');
