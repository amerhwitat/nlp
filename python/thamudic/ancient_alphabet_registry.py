...
def load_alphabet_registry() -> dict[str, dict[str, Any]]:
    ...
    for item in data["languages"]:
        profile = dict(item)
        profile.update(metadata.get(item["id"], {}))
...
def language_profile(language: str) -> dict[str, Any]:
    ...
    aliases = {
        "egyptian": "ancient-egyptian", "ancient-egyptian": "ancient-egyptian",
        "akkadian": "akkadian", "sumerian": "sumerian", "ugaritic": "ugaritic",
        "phoenician": "phoenician", "hebrew": "ancient-hebrew", "ancient-hebrew": "ancient-hebrew",
        "aramaic": "aramaic", "ancient-north-arabian": "ancient-north-arabian",
        "old-south-arabian": "old-south-arabian", "greek": "greek", "ancient-greek": "greek",
        "latin": "latin", "chinese": "chinese", "japanese": "japanese", "old-persian": "old-persian",
        "sanskrit": "sanskrit", "coptic": "coptic", "hittite": "hittite", "luwian": "luwian",
        "etruscan": "etruscan", "gothic": "gothic", "old-turkic": "old-turkic",
        "linear-b-greek": "linear-b-greek", "linear-b": "linear-b-greek", "cypro-minoan": "cypro-minoan",
    }
...
def translation_directions(language: str) -> dict[str, bool]:
    ...
    return {
        "source_to_transliteration": any("script-to-transliteration" in m or "cuneiform-to-transliteration" in m or "hieroglyph-to-transliteration" in m or "han-to-reading" in m for m in modes),
