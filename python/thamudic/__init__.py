...
# Must run before importing scientific/OCR-backed modules anywhere in this package.
...
from .artifact_legacy_adapter import migrate_legacy_objects, convert_legacy_record
